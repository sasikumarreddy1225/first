...
@Model(adaptables = { SlingHttpServletRequest.class,
		Resource.class }, defaultInjectionStrategy = DefaultInjectionStrategy.OPTIONAL, resourceType = ProductListingDataModel.RESOURCETYPE)
public class ProductListingDataModel extends TagsDataModel implements GenericDataModel {

	protected static final String RESOURCETYPE = "srp/components/common/wsp/product-listing";
	...
	public String toString() {
		return "ProductListingDataModel [getLabels()=" + getLabels() + ", getExperienceFragments()=" + getExperienceFragments() + "]";
	}
