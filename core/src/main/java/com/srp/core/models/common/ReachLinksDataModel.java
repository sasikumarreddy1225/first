...
public class ReachLinksDataModel extends TagsDataModel implements GenericDataModel {
	...
	public String toString() {
		return "ReachLinksDataModel [getLabel()=" + getLabel() + ", getType()=" + getType() + ", getLinkType()="
