...
@Model(adaptables = { SlingHttpServletRequest.class,
		Resource.class }, defaultInjectionStrategy = DefaultInjectionStrategy.OPTIONAL, resourceType = ProductCardDataModel.RESOURCETYPE)
public class ProductCardDataModel extends TagsDataModel implements GenericDataModel{
	
	protected static final String RESOURCETYPE = "srp/components/common/wsp/product-card";
	...
	public String toString() {
		return "ProductCardDataModel [getExperienceFragments()=" + getExperienceFragments() + ", getLabels()="
				+ getLabels() + "]";
	}
