...
@Model(adaptables = { SlingHttpServletRequest.class,
		Resource.class }, defaultInjectionStrategy = DefaultInjectionStrategy.OPTIONAL, resourceType = MyFavouritesProductListDataModel.RESOURCETYPE)
public class MyFavouritesProductListDataModel extends TagsDataModel implements GenericDataModel {

	protected static final String RESOURCETYPE = "srp/components/common/wsp/my-favourites-list";
	...
	public String toString() {
		return "MyFavourtiesProductListDataModel [getLabels()=" + getLabels() + ", getExperienceFragments()=" + getExperienceFragments() + "]";
	}
