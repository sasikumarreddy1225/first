...
@Model(adaptables = { SlingHttpServletRequest.class,
		Resource.class }, defaultInjectionStrategy = DefaultInjectionStrategy.OPTIONAL, resourceType = ProductDetailsDataModel.RESOURCETYPE)
public class ProductDetailsDataModel extends TagsDataModel implements GenericDataModel {
	protected static final String RESOURCETYPE = "srp/components/common/wsp/product-details";
	...
	public String toString() {
		return "ProductDetailsDataModel [getExperienceFragments()=" + getExperienceFragments() + ", getLabels()="
				+ getLabels() + "]";
	}
