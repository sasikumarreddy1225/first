...
@Model(adaptables = { SlingHttpServletRequest.class,
		Resource.class }, defaultInjectionStrategy = DefaultInjectionStrategy.OPTIONAL, resourceType = FrequentlyPurchasedDataModel.RESOURCETYPE)
public class FrequentlyPurchasedDataModel extends TagsDataModel implements GenericDataModel{
	
protected static final String RESOURCETYPE = "srp/components/common/wsp/frequently-purchased";
	...
	public String toString() {
		return "FrequentlyPurchasedDataModel [getLabels()=" + getLabels() + ", getExperienceFragments()=" + getExperienceFragments() + "]";
	}
