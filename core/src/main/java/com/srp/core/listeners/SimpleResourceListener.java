 ...
 */
package com.srp.core.listeners;
 ...
 * for. Please note, that apart from EventHandler services, the immediate flag
 * should not be set on a service.
 */
...
public class SimpleResourceListener implements ResourceChangeListener {
	...
	public void onChange(List<ResourceChange> changes) {
		changes.forEach(change -> logger.debug("Resource event: {} at: {} isExternal: {}", change.getType(),
				change.getPath(), change.isExternal()));
	}
